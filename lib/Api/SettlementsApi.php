...
class SettlementsApi
{
     ...
     * Gets settlements
     *
     * @param  bool|null $unExportedOnly Filter on settlements that have not been exported before. (optional)
     * @param  int[]|null $settlementIds Filter on settlement IDs. (optional)
     * @param  string[]|null $channelSettlementNos Filter on channel settlement nos. (optional)
     * @param  int[]|null $channelIds Filter on channel id list. (optional)
     * @param  \DateTime|null $fromStartDate Filter on the start date of the settlement in ChannelEngine, until this date. This date is exclusive. (optional)
     * @param  \DateTime|null $toStartDate Filter on the start date of the settlement in ChannelEngine, until this date. This date is exclusive. (optional)
     * @param  \DateTime|null $fromEndDate Filter on the end date of the settlement in ChannelEngine, starting from this date. This date is inclusive. (optional)
     * @param  \DateTime|null $toEndDate Filter on the end date of the settlement in ChannelEngine, until this date. This date is exclusive. (optional)
     * @param  \DateTime|null $fromCreateDate Filter on the create date of the settlement in ChannelEngine, until this date. This date is exclusive. (optional)
     * @param  \DateTime|null $toCreateDate Filter on the create date of the settlement in ChannelEngine, until this date. This date is exclusive. (optional)
     * @param  \DateTime|null $fromUpdateDate Filter on the update date of the settlement in ChannelEngine, starting from this date. This date is inclusive. (optional)
     * @param  \DateTime|null $toUpdateDate Filter on the update date of the settlement in ChannelEngine, until this date. This date is exclusive. (optional)
     ...
     * @return \ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantSettlementReportsResponse|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse
     */
     ...
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantSettlementReportsResponse|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function settlementGetByFilterWithHttpInfo($unExportedOnly = null, $settlementIds = null, $channelSettlementNos = null, $channelIds = null, $fromStartDate = null, $toStartDate = null, $fromEndDate = null, $toEndDate = null, $fromCreateDate = null, $toCreateDate = null, $fromUpdateDate = null, $toUpdateDate = null, $page = null, string $contentType = self::contentTypes['settlementGetByFilter'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantSettlementReportsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantSettlementReportsResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantSettlementReportsResponse', []),
            ...
            $returnType = '\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantSettlementReportsResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantSettlementReportsResponse',
     ...
     * @param  int|null $channelId The channel ID of the channel which the settlement is for. (optional)
