...
class ProductsApi
{
     ...
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\FreezeProductRequest[] $freezeProductRequest freezeProductRequest (optional)
     ...
     * Updates selected products and sets them either to frozen or not-frozen status.
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\FreezeProductRequest[] $freezeProductRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productFreeze'] to see the possible values for this operation
     *
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
