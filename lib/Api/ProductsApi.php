...
class ProductsApi
{
     ...
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\PatchMerchantProductDto|null $patchMerchantProductDto 1) PropertiesToUpdate: Fields to update &lt;br /&gt;2) MerchantProductRequestModels: Products to be updated (optional)
     ...
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest[]|null $merchantProductExtraDataRequest merchantProductExtraDataRequest (optional)
     ...
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChannelEngine\Merchant\ApiClient\Model\SingleOfProductCreationResult|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse
     */
     ...
     * Adds, updates, or deletes custom attributes
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest[]|null $merchantProductExtraDataRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productBulkPatchExtraDataItems'] to see the possible values for this operation
     *
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChannelEngine\Merchant\ApiClient\Model\SingleOfProductCreationResult|\ChannelEngine\Merchant\ApiClient\Model\ApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  bool|null $ignoreStock ignoreStock (optional, default to false)
     * @param  bool|null $ignorePrice ignorePrice (optional, default to false)
     ...
     * @param  bool|null $ignoreStock (optional, default to false)
     * @param  bool|null $ignorePrice (optional, default to false)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productCreate'] to see the possible values for this operation
     *
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\FreezeProductRequest[]|null $freezeProductRequest freezeProductRequest (optional)
     ...
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ChannelEngine\Merchant\ApiClient\Model\SingleOfApiResponse
     */
     ...
     * Updates selected products and sets them either to frozen or not-frozen status.
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\FreezeProductRequest[]|null $freezeProductRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['productFreeze'] to see the possible values for this operation
     *
     * @throws \ChannelEngine\Merchant\ApiClient\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ChannelEngine\Merchant\ApiClient\Model\SingleOfApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function productFreezeWithHttpInfo($freezeProductRequest = null, string $contentType = self::contentTypes['productFreeze'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfApiResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ChannelEngine\Merchant\ApiClient\Model\SingleOfApiResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ChannelEngine\Merchant\ApiClient\Model\SingleOfApiResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\ChannelEngine\Merchant\ApiClient\Model\SingleOfApiResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ChannelEngine\Merchant\ApiClient\Model\SingleOfApiResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * Gets products
     *
     * @param  string|null $search Search product(s) by Name, MerchantProductNo, Ean or Brand &lt;br /&gt;This search is applied to the result after applying the other filters. (optional)
     * @param  string[]|null $eanList Search products by submitting a list of EAN&#39;s. (optional)
     * @param  string[]|null $merchantProductNoList Search products by submitting a list of MerchantProductNo&#39;s. (optional)
