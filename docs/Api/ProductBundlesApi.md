# ChannelEngine\Merchant\ApiClient\ProductBundlesApi
...
```php
productBundleGetByFilter($search, $eanList, $merchantProductNoList, $page): \ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantProductBundleResponse
```
...
$apiInstance = new ChannelEngine\Merchant\ApiClient\Api\ProductBundlesApi(
...
[**\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantProductBundleResponse**](../Model/CollectionOfMerchantProductBundleResponse.md)
