# ChannelEngine\Merchant\ApiClient\ProductsApi
...
$merchantProductExtraDataRequest = array(new \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest()); // \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest[]
...
[**\ChannelEngine\Merchant\ApiClient\Model\SingleOfMerchantProductResponse**](../Model/SingleOfMerchantProductResponse.md)
...
```php
productPatch($merchantProductNo, $operation): \ChannelEngine\Merchant\ApiClient\Model\SingleOfProductCreationResult
```
...
$merchantProductExtraDataRequest = new \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest(); // \ChannelEngine\Merchant\ApiClient\Model\MerchantProductExtraDataRequest
